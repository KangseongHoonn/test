...
<script>
	...
	function postcheck(){
		window.open("post_check.jsp","postcheck","width=300 height=300");
	}
...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="./img/title1.gif" ><br>    
	<form name="member" method="post" action="/Member/userinfo_insert.do">
									...
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td><input type=text name=zip size=6 maxlength=6 ></td>
                  							<td><a href="postcheck"><img src="./img/u_bt07.gif" hspace=2 border=0 name=img2 align=absmiddle></a></td>
										</tr>
									</table>
								</td>
							</tr>
