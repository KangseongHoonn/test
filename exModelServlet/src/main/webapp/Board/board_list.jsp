      ...
      <tr>
		...
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="/Board/board_view.do?idx=<%=b.getIdx()%>&page=<%=nowpage%>"><%=b.getSubject() %></a></td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" href="mailto:ein1027@nate.com"><%=b.getName() %></a></font></td>
				<td align="center" height="20"><font face="돋움" size="2"><%=b.getRegdate().substring(0,10) %></font></td>
				<td align="center" height="20"><font face="돋움" size="2">
				<%=b.getReadcnt() %></font></td>
		</tr>
		<%
 	   		}
		%>
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="board" method="post" action="/Board/board_list.do">	
			...
			<a href="/Board/board_write.do?page=<%=nowpage%>"><img src="./img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
