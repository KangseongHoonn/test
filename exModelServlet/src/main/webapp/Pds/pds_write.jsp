   	...
   	function send(){
   		...
   		if(pds.filename.value!=""){
   			var size = pds.filename.files[0].size;
   	   		if(size > (2*1024*1024)){//파일용량 2mb
   	   			alert("파일용량은 2mb 이내로 제한");
   	   			pds.filename.focus();
   	   			return;
   	   		}
   		}
...
<!--     다음에 추가할 로그인  -->
   ...
   <td width="80%" valign="top">&nbsp;<br>
	...
	<form name="pds" method="post" enctype="multipart/form-data" action="/Pds/pds_write.do">
	  <table border="0" >
		<tr>
       ...
       <tr>
		...
		<tr>
		  ...
		  <td><input type="file" name="filename" size="30" onchange="checkSize(this)"></td></tr>
		<tr>
       <tr>
         <td align="right"><img src="./img/bullet-02.gif"></td>
		...
		<tr></tr>			<tr></tr>
          ...
          <td align=center>
			...
			<a href="javascript:history.back()"><img src="./img/purple_cancle.gif" width="56" height="18" border="0"></a>
